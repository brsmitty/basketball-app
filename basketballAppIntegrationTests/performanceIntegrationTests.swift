...
class performanceIntegrationTests: XCTestCase {
    ...
    func testUidTidPassedFromPerformanceViewToPlaybookView() {
        let src = storyboard.instantiateViewController(withIdentifier: "performanceView") as! PerformanceViewController
    ...
    func testUidTidPassedFromPerformanceViewToKpiView() {
        let src = storyboard.instantiateViewController(withIdentifier: "performanceView") as! PerformanceViewController
    ...
    func testUidTidPassedFromPerformanceViewToPlayerManagerView() {
        let src = storyboard.instantiateViewController(withIdentifier: "performanceView") as! PerformanceViewController
    ...
    func testUidTidPassedFromPerformanceViewToGameView() {
        let src = storyboard.instantiateViewController(withIdentifier: "performanceView") as! PerformanceViewController
    ...
    func testUidTidPassedFromPerformanceViewToScheduleView() {
        let src = storyboard.instantiateViewController(withIdentifier: "performanceView") as! PerformanceViewController
    ...
    func testUidTidPassedFromPerformanceViewToMiddleView() {
        let src = storyboard.instantiateViewController(withIdentifier: "performanceView") as! PerformanceViewController
