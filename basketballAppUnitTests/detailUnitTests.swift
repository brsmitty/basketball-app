...
class detailScheduleUnitTests: XCTestCase {
   ...
   override func setUp() {
      ...
      viewController = (storyboard.instantiateViewController(withIdentifier: "DetailScheduleViewController") as! DetailViewController)
   ...
   func testElementsExistWithFormatting(){
      ...
      // Text Field
      XCTAssertNotNil(viewController.GameDetail)
      ...
      XCTAssert(viewController.GameDetail.layer.cornerRadius == 5)
